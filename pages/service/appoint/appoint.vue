<template>
	<view>
		...
		<view class="basic-info">
			...
			<view class="basic">
				<view>{{doctor.name}}「{{doctor.sexName}}」</view>
		...
		<u-table :align="align" :borderColor="borderColor" class="table">
			<u-tr class="u-tr">
...
<script>
	...
	export default {
		...
		methods: {
			...
			appointDoctor(appointment, time) {
				console.log(appointment, time)
				appoint({
					appointment: appointment,
					do_id: this.doctor.id,
					do_name: this.doctor.name,
					time: time
				}).then(res => {
					console.log(res)
				})
